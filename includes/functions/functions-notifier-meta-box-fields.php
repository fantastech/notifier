...
function notifier_wp_file_input( $field ) {
	...
	if ('' == $image_thumb) {
		echo '<img id="' . esc_attr( $field['id'] ) . '_preview" class="notifier-media-preview" src="' . esc_url($image_thumb) . '" /><br/>' . "\n";
	}

	echo '<input id="' . esc_attr( $field['id'] ) . '_button" type="button" data-uploader_title="' . esc_attr($field['uploader_title']) . '" data-uploader_button_text="' . esc_attr($field['uploader_button_text']) . '" data-uploader_supported_file_types="' . esc_attr(json_encode($field['uploader_supported_file_types'])) . '" class="notifier-media-upload-button button" value="Upload" />' . "\n";
