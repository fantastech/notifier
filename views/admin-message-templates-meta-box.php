			...
			<div class="col w-50">
				...
				notifier_wp_file_input(
					array(
						...
						'description'       => 'Let WhatsApp know the kind of image you\'ll be sending by uploading an example image for their approval. They will check if the image meets their guidelines before approving the template for use. Supported formats: <b>JPEG and PNG</b>.',
						'custom_attributes' => $disabled,
				...
				notifier_wp_file_input(
					array(
						...
						'description'       => 'Let WhatsApp know the kind of video you\'ll be sending by uploading an example video for their approval. They will check if the video meets their guidelines before approving the template for use. Supported format: <b>MP4</b>',
						'custom_attributes' => $disabled,
				...
				notifier_wp_file_input(
					array(
						...
						'description'       => 'Let WhatsApp know the kind of image you\'ll be sending by uploading an example image for their approval. They will check if the image meets their guidelines before approving the template for use. Supported format: <b>PDF</b>',
						'custom_attributes' => $disabled,
